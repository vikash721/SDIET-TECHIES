      ...
      <footer className="footer bg-[#291e00] text-white p-10">
        <div className="flex justify-between flex-wrap w-full">
          ...
          <aside className="mb-4 w-full sm:w-auto">
            ...
            <p>
              SDIETTechies Event Management
              <br />
              Bringing College Events to Life
            </p>
          </aside>

          {/* Event Categories */}
          <nav className="mb-4 w-full sm:w-auto">
            <h6 className="footer-title">Event Categories</h6>
          ...
          <nav className="mb-4 w-full sm:w-auto">
            ...
            <form>
              <input
                ...
                className="text-black input input-bordered w-full max-w-xs mb-4"
                required
              />
        ...
        <div className="text-center mt-8 ">
          <p className="text-sm">&copy; 2025 SDIETTechies. All Rights Reserved.</p>
        </div>
      </footer>
    </>
  );
